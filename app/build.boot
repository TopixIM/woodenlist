...
(task-options!
  pom {:project     'cumulo/woodenlist
       :version     +version+
       :description "Woodenlist"
...
(defn html-dsl [data fileset]
  (make-html
    (html {}
      (head {}
        (title {:attrs {:innerHTML "Woodenlist"}})
...
(deftask rsync []
  (with-pre-wrap fileset
    (sh "rsync" "-r" "target/" "tiye.me:repo/Cumulo/woodenlist" "--exclude" "main.out" "--delete")
    fileset))
...
(deftask watch-test []
  ...
  (comp
    (watch)
    (test :namespaces '#{woodenlist.test})))
