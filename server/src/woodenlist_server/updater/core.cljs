...
(defn updater [db op op-data state-id op-id op-time]
  (case op
    ...
    :task-group/change-role (task-group/change-role db op-data state-id op-id op-time)
    :task-group/toggle-hidden (task-group/toggle-hidden db op-data state-id op-id op-time)
    ...
    :task/delete (task/delete db op-data state-id op-id op-time)
    db))
